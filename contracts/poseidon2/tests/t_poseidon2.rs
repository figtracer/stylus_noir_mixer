...
fn matches_solidity_poseidon2_hash2() {
    let vectors: &[(&str, &str, &str)] = &[
        ("0x0", "0x0", "0x0b63a53787021a4a962a452c2921b3663aff1ffd8d5510540f8e659e782956f1"),
        ("0x1", "0x2", "0x038682aa1cb5ae4e0a3f13da432a95c77c5c111f6f030faf9cad641ce1ed7383"),
        ("0x7b", "0x1c8", "0x148c4666e2c5bce33dc53b30430808464f7ed76b28daf8a36722e93b49a31a5e"),
    ...
    for (x_hex, y_hex, h_hex) in vectors {
        ...
        assert_eq!(format!("{:#066x}", got), format!("{:#066x}", expected),
            "mismatch for x={}, y={}", x_hex, y_hex);
    }
}